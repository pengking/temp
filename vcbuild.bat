...
if not defined VS140COMNTOOLS goto vc-set-2008
if not exist "%VS140COMNTOOLS%\..\..\vc\vcvarsall.bat" goto vc-set-2008
...
if not exist roc.sln goto create-msvs-files-failed
...
:msbuild-found
msbuild roc.sln /t:%target% /p:Configuration=Release /p:Platform=%platform% /clp:NoSummary;NoItemAndPropertyList;Verbosity=minimal /nologo
