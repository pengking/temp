...
if not exist DuiLib.sln goto create-msvs-files-failed
...
:msbuild-found
msbuild DuiLib.sln /t:%target% /p:Configuration=Release /p:Platform=%platform% /clp:NoSummary;NoItemAndPropertyList;Verbosity=minimal /nologo
